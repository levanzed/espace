...
/**
 * External API shell for Availability.
 *
...
use local_espace\service\AvailabilityService;

/**
 * Availability external adapter.
 */
class availability extends external_api {
    ...
    public static function capability_matrix(): array {
        ...
        return (new AvailabilityService())->capability_matrix();
    }
