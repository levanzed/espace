...
/**
 * External API shell for Resource.
 *
...
use local_espace\service\ResourceService;

/**
 * Resource external adapter.
 */
class resource extends external_api {
    ...
    public static function capability_matrix(): array {
        ...
        return (new ResourceService())->capability_matrix();
    }
