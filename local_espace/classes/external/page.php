...
use local_espace\service\PageService;

/**
 * Page external adapter.
 */
class page extends external_api {
    ...
    public static function capability_matrix(): array {
        ...
        return (new PageService())->capability_matrix();
    }
