...
/**
 * Resource service framework for local_espace.
 *
 ...
 */
final class ResourceService extends BaseService {
    ...
    public function capability_matrix(): array {
        ...
        return ApiResponse::success('resource_capability_matrix', [
            'use_official_ws' => ["mod_resource_get_resources_by_courses", "mod_resource_view_resource", "core_files_upload"],
            'local_espace_gap' => 'Resource/file activity settings and file replacement',
